        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground font-body mt-6 max-w-2xl mx-auto text-lg">
              Kein Verkaufsgespräch. Kein Druck. Nur eine ehrliche Analyse deiner aktuellen Situation und ein klarer Plan, wie es weitergehen kann.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground font-body mb-8 leading-relaxed max-w-xl mx-auto">
              In einem kurzen Gespräch schauen wir gemeinsam auf deine aktuelle Situation. Ich zeige dir, ob und wie Funnelmate für dich Sinn macht – oder ob eine andere Lösung besser passt.
            </p>
            <a
          ...
          >
            {[
              ...
              { icon: Phone, label: "WhatsApp", value: "0152 23856537", href: "https://wa.me/4915223856537?text=Hey%2C%20ich%20interessiere%20mich%20für%20eine%20System-Analyse.", external: true },
