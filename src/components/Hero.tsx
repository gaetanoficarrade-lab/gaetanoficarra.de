...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      {/* Hero Shimmer stripes */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute inset-0 w-1/2 h-full bg-gradient-to-r from-transparent via-primary/[0.04] to-transparent animate-shimmer-hero-fast" />
        <div className="absolute inset-0 w-2/3 h-full bg-gradient-to-r from-transparent via-primary/[0.03] to-transparent animate-shimmer-hero-slow" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-secondary/10 rounded-full blur-3xl scale-110" />
              <img
                src={portrait}
                alt="Gaetano Ficarra - Zertifizierter GoHighLevel Admin"
                className="relative w-80 h-80 md:w-[420px] md:h-[420px] lg:w-[500px] lg:h-[500px] object-cover object-top rounded-full border-4 border-primary/30 shadow-[0_20px_60px_rgba(0,0,0,0.4)] animate-glow-pulse"
                width={500}
                height={500}
                fetchPriority="high"
              />
