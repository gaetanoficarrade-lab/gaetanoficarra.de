...
const testimonials = [
  ...
  },
  {
    name: "Thomas M.",
    role: "SaaS-Gründer",
    text: "Als SaaS-Anbieter brauchen wir zuverlässigen Support für unsere Kunden. Gaetano ist unser Go-To für alle HighLevel-Fragen. Seine Q&A-Calls sind Gold wert.",
    rating: 5,
  },
  {
    name: "Sarah L.",
