...
import { Plus, Pencil, Trash2, ArrowLeft, Save, Eye, EyeOff, LogOut } from "lucide-react";
            ...
            <div className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setEditing((prev) =>
                      prev ? { ...prev, title, slug: prev.id ? prev.slug : generateSlug(title) } : prev,
                    );
                  }}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditing((prev) => (prev ? { ...prev, cover_image: e.target.value || null } : prev))
                  }
                  placeholder="https://..."
                  className="mt-1"
                />
        ...
        <div className="container mx-auto px-6 py-8 max-w-4xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary mb-4 font-body"
              >
                  ...
                  <CardContent className="flex items-center justify-between p-6">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full font-body ${post.published ? "bg-green-500/10 text-green-400" : "bg-muted text-muted-foreground"}`}
                        >
                          {post.published ? (
                            <>
                              <Eye size={12} /> Live
